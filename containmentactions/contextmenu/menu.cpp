...
void Menu::restore(const KConfigGroup &config)
{
    ...
    this->containment()->setInternalAction(NSE::Data::ContextMenu::ADDWIDGETSACTION, m_actions[NSE::Data::ContextMenu::ADDWIDGETSACTION]);
    ...
    this->containment()->setInternalAction(NSE::Data::ContextMenu::EDITVIEWACTION, m_actions[NSE::Data::ContextMenu::EDITVIEWACTION]);


    //! Quit Application
    m_actions[NSE::Data::ContextMenu::QUITLATTEACTION] = new QAction(QIcon::fromTheme("application-exit"), i18nc("quit application", "Quit &SynDock"));
    connect(m_actions[NSE::Data::ContextMenu::QUITLATTEACTION], &QAction::triggered, this, &Menu::quitApplication);
    this->containment()->setInternalAction(NSE::Data::ContextMenu::QUITLATTEACTION, m_actions[NSE::Data::ContextMenu::QUITLATTEACTION]);
    ...
    this->containment()->setInternalAction(NSE::Data::ContextMenu::LAYOUTSACTION, m_actions[NSE::Data::ContextMenu::LAYOUTSACTION]);
    ...
    this->containment()->setInternalAction(NSE::Data::ContextMenu::ADDVIEWACTION, m_actions[NSE::Data::ContextMenu::ADDVIEWACTION]);
    ...
    this->containment()->setInternalAction(NSE::Data::ContextMenu::MOVEVIEWACTION, m_actions[NSE::Data::ContextMenu::MOVEVIEWACTION]);
    ...
    this->containment()->setInternalAction(NSE::Data::ContextMenu::PREFERENCESACTION, m_actions[NSE::Data::ContextMenu::PREFERENCESACTION]);
    connect(m_actions[NSE::Data::ContextMenu::PREFERENCESACTION], &QAction::triggered, [=](){
        QDBusInterface iface("org.syndromatic.SynDock", "/SynDock", "", QDBusConnection::sessionBus());
    ...
    this->containment()->setInternalAction(NSE::Data::ContextMenu::DUPLICATEVIEWACTION, m_actions[NSE::Data::ContextMenu::DUPLICATEVIEWACTION]);
    ...
    this->containment()->setInternalAction(NSE::Data::ContextMenu::EXPORTVIEWTEMPLATEACTION, m_actions[NSE::Data::ContextMenu::EXPORTVIEWTEMPLATEACTION]);
    ...
    this->containment()->setInternalAction(NSE::Data::ContextMenu::REMOVEVIEWACTION, m_actions[NSE::Data::ContextMenu::REMOVEVIEWACTION]);
...
K_PLUGIN_CLASS_WITH_JSON(Menu, "plasma-containmentactions-syndockcontextmenu.json")
