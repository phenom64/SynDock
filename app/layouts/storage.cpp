...
bool Storage::isLatteContainment(const Plasma::Containment *containment) const
{
    ...
    if (containment->pluginMetaData().pluginId() == QLatin1String("org.syndromatic.syndock.containment")) {
        return true;
    }
...
bool Storage::isLatteContainment(const KConfigGroup &group) const
{
    ...
    return pluginId == QLatin1String("org.syndromatic.syndock.containment");
}
