...
void ActionsHandler::initItems()
{
    ...
    QString itemid = NSE::Data::ContextMenu::LAYOUTSACTION;
    int itemindex = NSE::Data::ContextMenu::ACTIONSEDITORDER.indexOf(itemid);
    ...
    itemid = NSE::Data::ContextMenu::SEPARATOR1ACTION;
    itemindex = NSE::Data::ContextMenu::ACTIONSEDITORDER.indexOf(itemid);
    ...
    itemid = NSE::Data::ContextMenu::ADDWIDGETSACTION;
    itemindex = NSE::Data::ContextMenu::ACTIONSEDITORDER.indexOf(itemid);
    ...
    itemid = NSE::Data::ContextMenu::ADDVIEWACTION;
    itemindex = NSE::Data::ContextMenu::ACTIONSEDITORDER.indexOf(itemid);
    m_items[itemid] = new ActionsDialog::ActionListWidgetItem(QIcon::fromTheme("list-add"),
                                                              i18n("Add Dock/Panel"),
                                                              itemindex,
    ...
    itemid = NSE::Data::ContextMenu::MOVEVIEWACTION;
    itemindex = NSE::Data::ContextMenu::ACTIONSEDITORDER.indexOf(itemid);
    ...
    itemid = NSE::Data::ContextMenu::EXPORTVIEWTEMPLATEACTION;
    itemindex = NSE::Data::ContextMenu::ACTIONSEDITORDER.indexOf(itemid);
    ...
    itemid = NSE::Data::ContextMenu::REMOVEVIEWACTION;
    itemindex = NSE::Data::ContextMenu::ACTIONSEDITORDER.indexOf(itemid);
...
void ActionsHandler::loadItems(const QStringList &alwaysActions)
{
    for(int i=0; i<NSE::Data::ContextMenu::ACTIONSEDITORDER.count(); ++i) {
        QString actionname = NSE::Data::ContextMenu::ACTIONSEDITORDER[i];
